...
Pod::Spec.new do |s|
  s.name             = 'XYUIKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XYUIKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wenchao8023/XYUIKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wenchao8023' => '15629120502@163.com' }
  s.source           = { :git => 'https://github.com/wenchao8023/XYUIKit.git', :tag => s.version.to_s }
